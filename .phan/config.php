...
return [
    ...
    'exception_classes_with_optional_throws_phpdoc' => [
        ...
        'AssertionError',
        'TypeError',
        'TolerantASTConverter\InvalidNodeException',  // This is used internally in TolerantASTConverter
    ...
    'plugin_config' => [
        ...
        'has_phpdoc_method_ignore_regex' => '@^TolerantASTConverter\\\\Tests\\\\.*::(test.*|.*Provider)$@',
